...
cp ${WORKSPACE}/sd-terraform/config/config.json ${WORKSPACE}/stable-diffusion-webui/config.json
cp ${WORKSPACE}/sd-terraform/config/ui-config.json ${WORKSPACE}/stable-diffusion-webui/ui-config.json
cp ${WORKSPACE}/sd-terraform/config/webui-user.sh ${WORKSPACE}/stable-diffusion-webui/webui-user.sh
